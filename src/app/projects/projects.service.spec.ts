...
describe('ProjectsService', () => {
  ...
  it('should return a list of correctly formatted projects', () => {
    ...
    service.getProjects().subscribe((projects) => {
        ...
        const props = ['uuid', 'dcpUrl', 'addedToIndex', 'date', 'title',
          'organs', 'technologies', 'enaAccessions', 'geoAccessions',
          'arrayExpressAccessions', 'egaStudiesAccessions',
          'egaDatasetsAccessions', 'publications', 'authors'
        ];
        props.forEach(prop => {
    ...
    const req = httpTestingController.expectOne(`${environment.ingestApiUrl}${environment.catalogueEndpoint}`);
